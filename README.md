...
<p align="center">
  <b>这里有提供轮椅式的代码仓库与知识总结<br>考试时可直接复用的代码 + 分章节的知识点梳理</b>
</p>
...
- **[PPT](PPT/)** — 上课所用的完整课件（PDF 格式），共 10 章，部分章节分多次课讲授。
...
<p align="center">
  <sub>如有错误或改进建议，欢迎 <a href="mailto:24374180@buaa.edu.cn">联系作者</a> 或提交 Issue / Pull Request。</sub>
</p>
